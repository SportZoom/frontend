...
export class NotificationsComponent implements OnInit {
  ...
  getColor(type: string): string {
    switch(type) {
      case 'success': return 'bg-white border-blue-200 text-blue-800';
      case 'error': return 'bg-white border-gray-300 text-gray-800';
      case 'warning': return 'bg-white border-blue-200 text-gray-800';
      case 'info': return 'bg-white border-blue-200 text-blue-800';
      default: return '';
    }
  }
}
